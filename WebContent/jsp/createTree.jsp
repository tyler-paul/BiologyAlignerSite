...
<title>Create Phylogeny Tree</title>
</head>
<body>
	<div id="container">
		<jsp:include page="nav.jsp" />
		<div class="container">
			<p>To create a phylogeny tree, click the corresponding row in the table. A neighbor-joining algorithm will be used to construct the tree.</p>
			<table class="table table-striped table-hover table-bordered">
				...
				<tbody>
					<c:forEach var="alignment" items="${requestScope.alignments}">
						...
						onclick="window.document.location='/Controller?action=SetupOutgroup&id=${alignment.id}';"
						</c:if>
						>
							<td>${alignment.id}</td>
							<c:choose>
